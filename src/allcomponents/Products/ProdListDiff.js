...
const ProdListDiff = (props) => {
    ...
    const handleAddtoCart = () => {
        ...
        toast('😇 Your cart now holds this treasure!', {
            position: "top-center",
            autoClose: 5000,
            hideProgressBar: false,
            closeOnClick: true,
    ...
    return (
        <>
            <div>
                <div onClick={openModal} data-aos="zoom-in-down" data-aos-duration="500" className="group relative flex h-96 items-end overflow-hidden rounded-lg bg-gray-100 p-2 shadow-lg">
                    ...
                    <div className="relative flex justify-between w-full rounded-lg bg-white p-2 text-center">
