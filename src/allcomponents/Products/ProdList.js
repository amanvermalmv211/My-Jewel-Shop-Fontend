...
const ProdList = (props) => {
    ...
    const prodGoldPrice = (((metalGoldPrice / 24) * ktGold) / 10) * prodWeight;
        ...
        <>
            <div>
                <div data-aos="zoom-in-up" data-aos-duration="500">
                    <div onClick={openModal} className="group relative block h-96 overflow-hidden rounded-t-lg bg-gray-100 cursor-pointer">
                        <img src={proddetials.imglink} loading="lazy" alt="Austin Wade" className="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
                    ...
                    <div className="flex items-start justify-between gap-2 rounded-b-lg bg-gray-100 p-4">
                        <div className="flex flex-col">
                            ...
                            <span className="text-sm text-gray-500 lg:text-base">{ktGold}kt Gold</span>

                        </div>

                        <div className="flex flex-col items-end">
                            <span className="font-bold text-gray-600 lg:text-lg">₹ {userTotalCost.toFixed(2)}</span>
                            ...
                            <div className="bg-blue-200 text-black px-4 py-2 rounded-lg relative">
                                ...
                                <div>
                                    <div className='flex flex-col items-center justify-center text-sm'>
                                        ...
                                        {localStorage.getItem("myjeweladmintoken") && <div className='flex justify-between w-full'>
                                            <div>Quantity</div>
                                            <div>{proddetials.quantity}</div>
                                        </div>}
