...
const Necklace = (props) => {
    ...
    const [necklace, setNecklace] = useState({ name: "Necklace", imglink: "", weight: "", ktgold: "", makingcharge: "0", finalmakingcharge: "", gst: "3", quantity: "" });

    const handleNecklaceChange = (e) => {
        setNecklace({ ...necklace, [e.target.name]: e.target.value });
    };
    ...
    const handleLogin = async () => {
        if (localStorage.getItem("myjeweladmintoken")) {
            ...
            else if (!necklace.finalmakingcharge) {
            ...
            try {
                ...
                setNecklace({ name: "Necklace", imglink: "", weight: "", ktgold: "", makingcharge: "0", finalmakingcharge: "", gst: "3", quantity: "" });
            }
            catch (err) {
                toast.error('Internal Server Error Occured.', {
                    position: "top-center",
    ...
    return (
        <>
            <div className={`py-6 sm:py-8 lg:py-12 ${props.mode === "light" ? "text-gray-700" : "text-white"}`}>
                <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
                    <div className="mb-10 md:mb-16">
                        <h2 className={`mb-4 text-center text-2xl font-bold ${props.mode === "light" ? "text-gray-700" : "text-[#d4af37]"} md:mb-6 lg:text-3xl`}>Necklace</h2>
                        ...
                        {localStorage.getItem("myjeweladmintoken") ? <div className='flex items-center justify-center p-4'>
                                ...
                                <div className={`rounded-md shadow-sm space-y-2 ${props.mode === "light" ? "text-gray-700" : "text-white"}`}>
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <div className='flex'>
                                            <input
                                                ...
                                                value={necklace.imglink}
                                                onChange={handleNecklaceChange}
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            value={necklace.finalmakingcharge}
                                            onChange={handleNecklaceChange}
                                        />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            required
                                            className="appearance-none rounded-md relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
                                            placeholder="Enter the quantity of the Necklace"
                                            value={necklace.quantity}
                                            onChange={handleNecklaceChange}
                                        />
                                    </div>
                            ...
                            <p className={`mx-auto max-w-screen-md text-center md:text-lg`}>Our exquisite Necklace collection offers a stunning array of designs to enhance your beauty. From timeless classics to contemporary pieces, we have something for every taste and occasion.</p>}
            ...
            {
                localStorage.getItem("myjewelacctoken") && <OrderCall mode={props.mode} jewel={"Necklace"} />
            }
